  ...
  filtered.forEach(job => {
    ...
    card.innerHTML = `
      <div class="flex justify-between items-start">
        ...
        class="w-8 h-8 rounded-full flex items-center justify-center bg-gray-100 hover:bg-red-100 hover:text-red-500 transition">
      ...
      <div class="mt-3">
        <span class="text-xs font-medium px-3 py-2 rounded
          ${
            job.status === "all"
